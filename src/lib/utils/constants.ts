...
export const STATE_BOUNDS: Record<string, { center: [number, number]; zoom: number }> = {
	// States
	al: { center: [-86.8073, 32.799], zoom: 6.5 },
	...
	mo: { center: [-92.458, 38.3566], zoom: 6.5 },
	...
	tn: { center: [-86.3505, 35.858], zoom: 6.5 },
